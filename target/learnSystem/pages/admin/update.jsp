...
<body>
<div class="x-body">
    <form class="layui-form layui-form-pane" action="/admin/userInfoUpdate" method="post" enctype="multipart/form-data">
        <div class="layui-form-item">
            <label class="layui-form-label">用户名</label>
            <div class="layui-input-inline" id="user_name">
                <input type="text" required="" value="${user.userName}" class="layui-input" disabled>
            </div>
        </div>
        <div style="border: 1px solid #e6e6e6;border-radius:2px;position: absolute;left: 335px;top: 20px;">
            <a href="javascript:(0)" id="upload_face"><img id="face" src="../${user.face}" alt="修改头像" width="123"></a>
            <div align="center" style="position:relative;">上传头像</div>
            <input type="hidden"  value="${user.face}" id="face-src" name="face">
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input" lay-verify="required|phone|number"  placeholder="必填项，不可为空" name="tel" value="${user.tel}">
            </div>
        </div>
        <div class="layui-form-item">
