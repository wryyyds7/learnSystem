    ...
    <div class="layui-form layui-form-pane">
        <div class="layui-form layui-tab-content" id="LAY_ucm" style="padding: 20px 0;">
          <div class="layui-tab-item layui-show">
            <form action="/forum/addTopic" method="post">
              <div class="layui-row layui-col-space15 layui-form-item">
                ...
                <div class="layui-col-sm8">
                  ...
                  <div class="layui-input-block">
                    <input type="text" id="L_title" name="title"  lay-verify="title" autocomplete="off" class="layui-input">
                  </div>
                </div>
              </div>
              <div class="layui-form-item layui-form-text">
                <div class="layui-input-block">
                  <textarea id="content" name="content" placeholder="请输入帖子内容" class="layui-textarea" lay-verify="content" style="height: 260px;"></textarea>
                </div>
              </div>
